...
urlpatterns = [
    ...
    re_path(r'^order_detail/(?P<pk>.+)/$', DetalleOperacionPedido.as_view(), name="order_detail"),
    ...
    re_path(r'^listado_movimientos_pedido/(?P<order>.+)/$', ListadoMovimientosPorPedido.as_view(),
