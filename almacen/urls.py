...
urlpatterns = [
    ...
    url(r'^modificar_movimiento/(?P<pk>.+)/$', login_required(ModificarMovimiento.as_view()),
    ...
    url(r'^reporte_kardex_producto/$', login_required(ReporteKardexProducto.as_view()), name="reporte_kardex_producto"),
    ...
    url(r'^reporte_kardex/$', login_required(ReporteKardex.as_view()), name="reporte_kardex"),
    ...
    url(r'^listado_movimientos_pedido/(?P<pedido>.+)/$', login_required(ListadoMovimientosPorPedido.as_view()),
        name="listado_movimientos_pedido"),
    url(r'^reproceso_precio/$', login_required(ReprocesoPrecio.as_view()), name="reproceso_precio"),
    url(r'^movimientos_por_producto/$', login_required(MovimientosPorProducto.as_view()),
