...
urlpatterns = [
    ...
    url(r'^modificar_movimiento/(?P<id_movimiento>.+)/$', login_required(ModificarMovimiento.as_view()),
        name="modificar_movimiento"),
    url(r'^modificar_ingreso_almacen/(?P<pk>.+)/$', login_required(ModificarIngresoAlmacen.as_view()),
        name="modificar_ingreso_almacen"),
    url(r'^modificar_salida_almacen/(?P<pk>.+)/$', login_required(ModificarSalidaAlmacen.as_view()),
    ...
    url(r'^verificar_solicita_documento/$', login_required(VerificarSolicitaDocumento.as_view()),
        name="verificar_solicita_documento"),
    url(r'^verificar_pide_referencia/$', login_required(VerificarPideReferencia.as_view()),
        name="verificar_pide_referencia"),
    url(r'^generacion_kardex_producto/$', login_required(GeneracionKardexProducto.as_view()),
        name="generacion_kardex_producto"),
    ...
    url(r'^busqueda_productos_almacen/$', login_required(BusquedaProductosAlmacen.as_view()),
    ...
    url(r'^movimiento_pdf/(?P<id_movimiento>.+)/$', login_required(ReportePDFMovimiento.as_view()),
        name="movimiento_pdf"),
    ...
    url(r'^reporte_consolidado_productos_kardex/$', login_required(ReporteConsolidadoProductosKardexExcel.as_view()),
        name="reporte_consolidado_productos_kardex"),
    url(r'^reporte_consolidado_grupos_kardex/$', login_required(ReporteConsolidadoGruposKardexExcel.as_view()),
        name="reporte_consolidado_grupos_kardex"),
    ...
    url(r'^detalle_tipo_movimiento/(?P<pk>.+)/$', login_required(DetalleTipoMovimiento.as_view()),
        name="detalle_tipo_movimiento"),
    url(r'^detalle_pedido/(?P<pk>.+)/$', login_required(DetalleOperacionPedido.as_view()), name="detalle_pedido"),
    url(r'^detalle_movimiento/(?P<pk>.+)/$', login_required(DetalleOperacionMovimiento.as_view()),
    ...
    url(r'^maestro_tipos_movimientos_excel/$', login_required(ReporteExcelTiposMovimientos.as_view()),
        name="maestro_tipos_movimientos_excel"),
    url(r'^cargar_almacenes/$', login_required(CargarAlmacenes.as_view()), name="cargar_almacenes"),
    url(r'^cargar_inventario_inicial/$', login_required(CargarInventarioInicial.as_view()),
        name="cargar_inventario_inicial"),
    url(r'^listado_aprobacion_pedidos/$', login_required(ListadoAprobacionPedidos.as_view()),
        name="listado_aprobacion_pedidos"),
    url(r'^verificar_stock_para_pedido/$', login_required(VerificarStockParaPedido.as_view()),
