    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[(b'PEND', b'PENDIENTE'), (b'APROB', b'APROBADO'), (b'DESAP', b'DESAPROBADO'), (b'ATEN', b'ATENDIDO'), (b'ATEN_PARC', b'ATENDIDO PARCIALMENTE'), (b'CANC', b'CANCELADO')], default=b'PEND', max_length=20)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad_ingreso', models.DecimalField(decimal_places=5, max_digits=15)),
                ('precio_ingreso', models.DecimalField(decimal_places=5, max_digits=15)),
                ('valor_ingreso', models.DecimalField(decimal_places=5, max_digits=15)),
                ('cantidad_salida', models.DecimalField(decimal_places=5, max_digits=15)),
                ('precio_salida', models.DecimalField(decimal_places=5, max_digits=15)),
                ('valor_salida', models.DecimalField(decimal_places=5, max_digits=15)),
                ('cantidad_total', models.DecimalField(decimal_places=5, max_digits=15)),
                ('precio_total', models.DecimalField(decimal_places=5, max_digits=15)),
                ('valor_total', models.DecimalField(decimal_places=5, max_digits=15)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('almacen', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='almacen.Almacen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[(b'ACT', b'ACTIVO'), (b'CANC', b'CANCELADA')], default=b'ACT', max_length=20)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('almacen', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='almacen.Almacen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('id_movimiento', models.CharField(max_length=16, primary_key=True, serialize=False)),
                ('serie', models.CharField(max_length=15, null=True)),
                ('numero', models.CharField(max_length=10, null=True)),
                ('fecha_operacion', models.DateTimeField()),
                ('observaciones', models.TextField(default=b'')),
        ...
        migrations.AddField(
            model_name='movimiento',
            name='tipo_documento',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='contabilidad.TipoDocumento'),
        ),
        migrations.AddField(
            model_name='movimiento',
        ...
        migrations.AddField(
            ...
            name='pedido',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='almacen.Pedido'),
        ),
        migrations.AddField(
            model_name='historicalmovimiento',
            name='referencia',
        ...
        migrations.AddField(
            model_name='historicalmovimiento',
            name='tipo_documento',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='contabilidad.TipoDocumento'),
        ),
        migrations.AddField(
            model_name='historicalmovimiento',
            name='tipo_movimiento',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='almacen.TipoMovimiento'),
        ),
        migrations.AddField(
            model_name='historicalkardex',
            name='movimiento',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='almacen.Movimiento'),
        ),
        migrations.AddField(
            model_name='historicalkardex',
            name='producto',
