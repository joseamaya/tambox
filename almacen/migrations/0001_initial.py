...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='pedido',
            field=models.ForeignKey(to='almacen.Pedido', null=True),
        ),
        migrations.AddField(
            model_name='movimiento',
            name='referencia',
            field=models.ForeignKey(to='compras.OrdenCompra', null=True),
        ),
        migrations.AddField(
            model_name='movimiento',
            name='tipo_documento',
            field=models.ForeignKey(to='contabilidad.TipoDocumento', null=True),
        ),
        migrations.AddField(
            model_name='movimiento',
