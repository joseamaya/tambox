    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad_ingreso', models.DecimalField(decimal_places=5, max_digits=20)),
                ('precio_ingreso', models.DecimalField(decimal_places=5, max_digits=20)),
                ('valor_ingreso', models.DecimalField(decimal_places=5, max_digits=20)),
                ('cantidad_salida', models.DecimalField(decimal_places=5, max_digits=20)),
                ('precio_salida', models.DecimalField(decimal_places=5, max_digits=20)),
                ('valor_salida', models.DecimalField(decimal_places=5, max_digits=20)),
                ('cantidad_total', models.DecimalField(decimal_places=5, max_digits=20)),
                ('precio_total', models.DecimalField(decimal_places=5, max_digits=20)),
                ('valor_total', models.DecimalField(decimal_places=5, max_digits=20)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('almacen', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='almacen.Almacen')),
