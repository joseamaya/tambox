    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('ver_bienvenida', 'Puede ver bienvenida a la aplicaci\xf3n'),
                                ...
                                ('ver_detalle_almacen', 'Puede ver detalle Almac\xe9n'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(
                    choices=[(b'PEND', b'PENDIENTE'), (b'APROB', b'APROBADO'), (b'DESAP', b'DESAPROBADO'),
                             (b'ATEN', b'ATENDIDO'), (b'ATEN_PARC', b'ATENDIDO PARCIALMENTE'), (b'CANC', b'CANCELADO')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[(b'ACT', b'ACTIVO'), (b'CANC', b'CANCELADA')], default=b'ACT',
                                            max_length=20)),
                ('almacen', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='almacen.Almacen')),
                ('oficina', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                              to='administracion.Oficina')),
                ('referencia',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compras.OrdenCompra')),
                ('tipo_documento', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'oficina',
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='administracion.Oficina')),
                ('solicitante',
            ...
            options={
                'permissions': (
                    ...
                    ('ver_tabla_aprobacion_pedidos', 'Puede ver tabla de Aprobaci\xf3n de Pedidos'),
