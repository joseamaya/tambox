    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oficina', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='administracion.oficina')),
                ('productor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='administracion.productor')),
                ('referencia', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compras.ordencompra')),
                ('tipo_documento', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='contabilidad.tipodocumento')),
                ('trabajador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='administracion.trabajador')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movimiento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='almacen.movimiento')),
            ],
            options={
                'verbose_name': 'Kardex',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=8, max_digits=25)),
                ('amount', models.DecimalField(decimal_places=8, max_digits=25)),
                ('detalle_orden_compra', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compras.detalleordencompra')),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='productos.producto')),
                ('detalle_pedido', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='almacen.detallepedido')),
                ('movimiento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='almacen.movimiento')),
            ],
            options={
