...
class PageContentTest(TestCase):
    ...
    def test_lists_products_shows_description(self):
        ...
        respuesta = self.client.get(reverse('products:product_list'))
    ...
    def test_lists_movements_shows_type(self):
        ...
        respuesta = self.client.get(reverse('warehouse:movement_list'))
    ...
    def test_detail_movement_shows_product(self):
        ...
        respuesta = self.client.get(reverse('warehouse:movement_detail_view', args=[movement.pk]))
    ...
    def test_lists_orders_purchase_shows_code(self):
        ...
        respuesta = self.client.get(reverse('purchases:purchase_order_list'))
    ...
    def test_detail_requirement_shows_product(self):
        ...
        respuesta = self.client.get(reverse('requirements:requirement_detail',
    ...
    def test_lists_accounts_shows_account(self):
        ...
        respuesta = self.client.get(reverse('accounting:account_list'))
    ...
    def test_lists_offices_shows_name(self):
        ...
        respuesta = self.client.get(reverse('administration:office_list'))
    ...
    def test_form_follows_rendering_fields(self):
        ...
        respuesta = self.client.get(reverse('warehouse:movement_type_create'))
    ...
    def test_lists_units_measure_shows_description(self):
        ...
        respuesta = self.client.get(reverse('products:unit_of_measure_list'))
    ...
    def test_lists_groups_products_shows_description(self):
        ...
        respuesta = self.client.get(reverse('products:product_group_list'))
    ...
    def test_lists_types_stock_type_shows_description(self):
        ...
        respuesta = self.client.get(reverse('accounting:stock_type_list'))
    ...
    def test_lists_warehouses_shows_description(self):
        ...
        respuesta = self.client.get(reverse('warehouse:warehouse_list'))
    ...
    def test_lists_types_movement_shows_description(self):
        ...
        respuesta = self.client.get(reverse('warehouse:movement_type_list'))
