...
class InventoryReportTest(TestCase):
    ...
    def test_generates_book(self):
        from warehouse.reports import inventory_report
    ...
    def test_includes_row_by_product(self):
        ...
        from products.models import ProductGroup, Product, UnitOfMeasure
...
class ConsolidatedKardexReportTest(TestCase):
    ...
    def report(self):
        from warehouse.reports import KardexPdfReport
        from products.models import ProductGroup
...
class KardexExcelReportTest(TestCase):
    ...
    *anterior* al periodo, no el ultimo a secas- porque en estos informes el
    ...
    def test_format_sunat_not_grows_with_catalogo(self):
        ...
        from django.db import connection
        from django.test.utils import CaptureQueriesContext
        from warehouse.reports import KardexExcelReport
