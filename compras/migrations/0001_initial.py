    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(
                    choices=[(b'PEND', b'PENDIENTE'), (b'ELEG', b'ELEGIDA'), (b'ELEG_PARC', b'ELEGIDA PARCIALMENTE'),
                             (b'DESC', b'DESCARTADA'), (b'CANC', b'CANCELADO')], default=b'PEND', max_length=20)),
            ],
            options={
                'permissions': (('ver_detalle_cotizacion', 'Puede ver detalle de Cotizaci\xf3n'),
                                ...
                                ('puede_hacer_transferencia_cotizacion', 'Puede hacer transferencia de Cotizaci\xf3n')),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', model_utils.fields.StatusField(
                    choices=[(b'PEND', b'PENDIENTE'), (b'ELEG', b'ELEGIDA'), (b'ELEG_PARC', b'ELEGIDA PARCIALMENTE'),
                             (b'DESC', b'DESCARTADA'), (b'CANC', b'CANCELADO')], default=b'PEND', max_length=100,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(
                    choices=[(b'PEND', b'PENDIENTE'), (b'ING', b'INGRESADO'), (b'ING_PARC', b'INGRESADO PARCIALMENTE'),
                             (b'CANC', b'CANCELADO')], default=b'PEND', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(
                    choices=[(b'PEND', b'PENDIENTE'), (b'CONF', b'CONFORME'), (b'CONF_PARC', b'CONFORME PARCIALMENTE'),
                             (b'CANC', b'CANCELADA')], default=b'PEND', max_length=20)),
                ('detalle_cotizacion', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                                         to='compras.DetalleCotizacion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(
                    choices=[(b'PEND', b'PENDIENTE'), (b'ING', b'INGRESADA'), (b'ING_PARC', b'INGRESADA PARCIALMENTE'),
                             (b'CANC', b'CANCELADA')], default=b'PEND', max_length=20)),
                ('cotizacion',
