...
urlpatterns = [
    ...
    re_path(r'^detalle_cotizacion/(?P<pk>.+)/$', DetalleOperacionCotizacion.as_view(),
        name="detalle_cotizacion"),
    re_path(r'^detalle_orden_compra/(?P<pk>.+)/$', DetalleOperacionOrdenCompra.as_view(),
        name="detalle_orden_compra"),
    re_path(r'^detalle_orden_servicios/(?P<pk>.+)/$', DetalleOperacionOrdenServicios.as_view(),
    ...
    re_path(r'^orden_servicios_pdf/(?P<codigo>.+)/$', ReportePDFOrdenServicios.as_view(),
    ...
    re_path(r'^cotizacion_pdf/(?P<codigo>.+)/$', ReportePDFSolicitudCotizacion.as_view(),
        name="cotizacion_pdf"),
    re_path(r'^maestro_proveedores_excel/$', ReporteExcelProveedores.as_view(),
        name="maestro_proveedores_excel"),
    re_path(r'^reporte_ordenes_compra_fecha/$', ReporteExcelOrdenesCompraFecha.as_view(),
        name="reporte_ordenes_compra_fecha"),
    re_path(r'^reporte_ordenes_servicios_fecha/$', ReporteExcelOrdenesServiciosFecha.as_view(),
