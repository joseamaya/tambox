...
urlpatterns = [
    ...
    url(r'^listado_ordenes_servicios_cotizacion/(?P<cotizacion>.+)/$',
    ...
    url(r'^crear_detalle_orden_servicios/$', login_required(CrearDetalleOrdenServicios.as_view()),
    ...
    url(r'^listado_movimientos_orden_compra/(?P<orden>.+)/$',
        login_required(ListadoMovimientosPorOrdenCompra.as_view()), name="listado_movimientos_orden_compra"),
    url(r'^listado_conformidades_orden_servicios/(?P<orden>.+)/$',
    ...
    url(r'^reporte_ordenes_servicios_fecha/$', login_required(ReporteExcelOrdenesServiciosFecha.as_view()),
    ...
    url(r'^eliminar_orden_servicios/$', login_required(EliminarOrdenServicios.as_view()),
    ...
    url(r'^eliminar_conformidad_servicio/$', login_required(EliminarConformidadServicio.as_view()),
