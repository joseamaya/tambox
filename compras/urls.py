...
urlpatterns = [    
    ...
    url(r'^conformidades_servicio/$', login_required(ListadoConformidadesServicio.as_view()), name="conformidades_servicio"),
    url(r'^listado_cotizaciones/$',login_required(ListadoCotizaciones.as_view()), name="listado_cotizaciones"),
    url(r'^listado_ordenes_compra_cotizacion/(?P<cotizacion>.+)/$',login_required(ListadoOrdenesCompraPorCotizacion.as_view()), name="listado_ordenes_compra_cotizacion"),
    url(r'^listado_ordenes_servicios_cotizacion/(?P<cotizacion>.+)/$',login_required(ListadoOrdenesServiciosPorCotizacion.as_view()), name="listado_ordenes_servicios_cotizacion"),
    ...
    url(r'^modificar_orden_servicios/(?P<pk>.+)/$', login_required(ModificarOrdenServicios.as_view()), name="modificar_orden_servicios"),
    url(r'^modificar_conformidad_servicios/(?P<pk>.+)/$', login_required(ModificarConformidadServicio.as_view()), name="modificar_conformidad_servicios"),
    url(r'^modificar_cotizacion/(?P<pk>.+)/$',login_required(ModificarCotizacion.as_view()), name="modificar_cotizacion"),
    url(r'^busqueda_cotizacion/$', login_required(BusquedaCotizacion.as_view()), name="busqueda_cotizacion"),
    url(r'^busqueda_proveedores_razon_social/$', login_required(BusquedaProveedoresRazonSocial.as_view()), name="busqueda_proveedores_razon_social"),
    url(r'^busqueda_proveedores_ruc/$', login_required(BusquedaProveedoresRUC.as_view()), name="busqueda_proveedores_ruc"),
    url(r'^transferencia_cotizacion/$',login_required(TransferenciaCotizacion.as_view()), name="transferencia_cotizacion"),
    url(r'^transferencia_orden_compra/$',login_required(TransferenciaOrdenCompra.as_view()), name="transferencia_orden_compra"),
    url(r'^transferencia_orden_servicios/$',login_required(TransferenciaOrdenServicios.as_view()), name="transferencia_orden_servicios"),
    url(r'^obtener_detalle_cotizacion/$',login_required(ObtenerDetalleCotizacion.as_view()), name="obtener_detalle_cotizacion"),
    url(r'^obtener_detalle_orden_compra/$',login_required(ObtenerDetalleOrdenCompra.as_view()), name="obtener_detalle_orden_compra"),
    url(r'^obtener_detalle_orden_servicios/$',login_required(ObtenerDetalleOrdenServicios.as_view()), name="obtener_detalle_orden_servicios"),
    ...
    url(r'^maestro_proveedores_excel/$',login_required(ReporteExcelProveedores.as_view()), name="maestro_proveedores_excel"),
    ...
    url(r'^reporte_ordenes_servicios_fecha/$', login_required(ReporteExcelOrdenesServiciosFecha.as_view()), name="reporte_ordenes_servicios_fecha"),
