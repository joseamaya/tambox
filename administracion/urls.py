...
urlpatterns = [
    url(r'^tablero/$',login_required(Tablero.as_view()), name="tablero"),#1
    url(r'^tablero_inicio/$',login_required(TableroDefault.as_view()), name="tablero_inicio"),#1
    url(r'^maestro_oficinas/$',login_required(ListadoOficinas.as_view()), name="maestro_oficinas"),#1
    ...
    url(r'^maestro_puestos/$',login_required(ListadoPuestos.as_view()), name="maestro_puestos"),#1
    ...
    url(r'^maestro_profesiones/$',login_required(ListadoProfesiones.as_view()), name="maestro_profesiones"),#1
    ...
    url(r'^maestro_niveles_aprobacion/$',login_required(ListadoNivelesAprobacion.as_view()), name="maestro_niveles_aprobacion"),#1
