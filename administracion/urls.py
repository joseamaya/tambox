...
urlpatterns = [
    ...
    url(r'^maestro_trabajadores_excel/$', login_required(ReporteExcelTrabajadores.as_view()),
    ...
    url(r'^reporte_excel_profesiones/$', login_required(ReporteExcelProfesiones.as_view()),
    ...
    url(r'^modificar_trabajador/(?P<pk>.+)/$', login_required(ModificarTrabajador.as_view()),
    ...
    url(r'^busqueda_receptor_nombre/$', login_required(BusquedaReceptorNombre.as_view()),
    ...
    url(r'^maestro_niveles_aprobacion/$', login_required(ListadoNivelesAprobacion.as_view()),
        name="maestro_niveles_aprobacion"),
    url(r'^detalle_nivel_aprobacion/(?P<pk>.+)/$', login_required(DetalleNivelAprobacion.as_view()),
        name="detalle_nivel_aprobacion"),
    url(r'^modificar_nivel_aprobacion/(?P<pk>.+)/$', login_required(ModificarNivelAprobacion.as_view()),
