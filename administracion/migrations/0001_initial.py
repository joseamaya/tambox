    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dependencia', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='depende', to='administracion.Oficina')),
                ('gerencia', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='superior', to='administracion.Oficina')),
            ],
            options={
                'ordering': ['nombre'],
