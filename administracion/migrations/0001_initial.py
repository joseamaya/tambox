    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dependencia',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='depende',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False,
                                                                      verbose_name='modified')),
                ('archivo', models.FileField(storage=administracion.helpers.OverwriteStorage(), upload_to=b'archivos')),
            ],
            options={
                'abstract': False,
            },
