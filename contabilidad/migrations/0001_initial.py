    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('administracion', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                                     related_name='administracion', to='administracion.Oficina')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.BooleanField(default=True)),
                ('tipo_uso',
                 models.CharField(choices=[('COM', 'COMPRA'), ('VEN', 'VEN')], default='COM', max_length=20)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='configuracion',
            name='logistica',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='logistica',
                                    to='administracion.Oficina'),
        ),
        migrations.AddField(
            model_name='configuracion',
            name='operaciones',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='operaciones',
                                    to='administracion.Oficina'),
        ),
        migrations.AddField(
            model_name='configuracion',
            name='presupuesto',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='presupuesto',
                                    to='administracion.Oficina'),
        ),
    ]
