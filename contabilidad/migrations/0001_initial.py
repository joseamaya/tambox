    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lugar', models.CharField(default='', max_length=150)),
                ('calle', models.CharField(default='', max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.BooleanField(default=True)),
                ('tipo_uso', models.CharField(choices=[('COM', 'COMPRA'), ('VEN', 'VEN')], default='COM', max_length=20)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logistica', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='logistica', to='administracion.oficina')),
                ('operaciones', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='operaciones', to='administracion.oficina')),
                ('presupuesto', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='presupuesto', to='administracion.oficina')),
                ('impuesto_compra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='configurations', to='contabilidad.impuesto')),
            ],
            options={
                'abstract': False,
            },
