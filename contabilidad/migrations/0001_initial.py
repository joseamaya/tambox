    ...
    operations = [
            ...
            options={
                ...
                'permissions': (('cargar_cuentas_contables', 'Puede cargar Cuentas Contables desde un archivo externo'),
                                ...
                                ('ver_tabla_cuentas_contables', 'Puede ver tabla de Cuentas Contables'), (
                                    'ver_reporte_cuentas_contables_excel',
                                    'Puede ver Reporte Cuentas Contables en excel')),
            },
        ),
        migrations.CreateModel(
            name='Empresa',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.BooleanField(default=True)),
                ('tipo_uso',
                 models.CharField(choices=[(b'COM', b'COMPRA'), (b'VEN', b'VEN')], default=b'COM', max_length=20)),
            ],
            options={
