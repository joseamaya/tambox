...
class AprobacionRequerimientoQuerySet(models.query.QuerySet):
    ...
    def aprobaciones_pendientes_oficina_usuario(self, requerimientos, estado):
        return self.filter(requerimiento__in=requerimientos, estado=estado)
    
    def aprobaciones_pendientes_gerencia_usuario(self, requerimientos, estado):
        return self.filter(requerimiento__in=requerimientos, estado=estado)