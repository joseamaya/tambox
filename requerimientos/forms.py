...
class FormularioDetalleRequerimientoProducto(forms.Form):
    ...
    cantidad = forms.DecimalField(6, widget=forms.TextInput(attrs={'size': 6, 'class': 'entero form-control'}))
...
class FormularioDetalleRequerimiento(forms.Form):
    ...
    cantidad = forms.DecimalField(max_digits=15, decimal_places=5, widget=forms.TextInput(attrs={'size': 4, 'class': 'form-control cantidad decimal'}))
