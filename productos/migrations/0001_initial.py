    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ctacontable',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contabilidad.CuentaContable')),
            ],
            options={
                'permissions': (('cargar_grupo_productos', 'Puede cargar Grupos de Productos desde un archivo externo'),
                                ...
                                'ver_reporte_grupo_productos_excel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ctacontable', models.ForeignKey(blank=True, db_constraint=False, null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type',
                 models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('grupo_productos', models.ForeignKey(blank=True, db_constraint=False, null=True,
                                                      on_delete=django.db.models.deletion.DO_NOTHING, related_name='+',
                                                      to='productos.GrupoProductos')),
                ('history_user',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+',
                                   to=settings.AUTH_USER_MODEL)),
                ('tipo_existencia', models.ForeignKey(blank=True, db_constraint=False, null=True,
                                                      on_delete=django.db.models.deletion.DO_NOTHING, related_name='+',
                                                      to='contabilidad.TipoExistencia')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.BooleanField(default=True)),
                ('grupo_productos',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='productos.GrupoProductos')),
                ('tipo_existencia', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                                      to='contabilidad.TipoExistencia')),
            ],
            options={
