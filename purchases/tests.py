...
class PurchaseOrderXlsReportTest(TestCase):
    ...
    def test_generates_book(self):
        ...
        from purchases.reports import purchase_order_xls_report
...
class PdfReportsTest(TestCase):
    ...
    def test_order_purchase(self):
        from purchases.models import PurchaseOrder
        from purchases.reports import PurchaseOrderPdf
    ...
    def test_order_services(self):
        from purchases.models import ServiceOrder
        from purchases.reports import ServiceOrderPdf
    ...
    def test_request_quotation_without_logo(self):
        from purchases.reports import QuotationRequestPdf
